...
class DarwinImagesData extends Equatable {
  const DarwinImagesData({
    required this.appLogo,
    required this.backgroundPattern,
  });

  factory DarwinImagesData.regular({required PictureProvider appLogo}) =>
      DarwinImagesData(
        appLogo: appLogo,
  ...
  DarwinImagesData withAppLogo(PictureProvider appLogo) {
    return DarwinImagesData(
      appLogo: appLogo,
      backgroundPattern: backgroundPattern,
    );
  }

  DarwinImagesData withBackgroundPattern(ImageProvider backgroundPattern) {
    return DarwinImagesData(
      appLogo: appLogo,
      backgroundPattern: backgroundPattern,
    );
